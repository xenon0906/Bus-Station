...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Uttarakhand Express","Haryana Express","Delhi Express","UP Express","Rajasthan Express","MP Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
getch();
    ...
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    printf("\t\t\tBrought To You By Siddhanth");
    getch();
    return 0;
}
    ...
    do
{
	...
	i=0;
	//scanf("%s",&pword); 
		if(strcmp(uname,"sid")==0 && strcmp(pword,"123")==0)
	{
	...
	{
		printf("\n        SORRY !!!!  THE LOGIN IS UNSUCESSFUL");
		a++;
